...
<table border="1">
	<tr>
	<th>과일코드</th> <th>과일이름</th> <th>가격</th> <th>재고</th>
	</tr>
<%
	for(FruitVO vo: list){%>
...
<form action="sales.jsp" method="post">
	과일코드: <input type="number" name="fruit_code" style="width:30px;height:20px;">
	구매수량: <input type="number" name="sales_quantity" style="width:30px;height:20px;">
...
<%
	...
	if((fruit_code!=null && sales_quantity!=null)){  //총가격을 보여줄려면 최소접속이 아니고
		if((fruit_code.length()!=0 && sales_quantity.length()!=0)){  //두개다 값도 있어야 한다.
